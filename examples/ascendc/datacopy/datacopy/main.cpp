 ...
 * The input is filled with the constant 0.0; after running, the host side verifies it is approx 1.0. dtype=float.
 */
#include <cstdio>
#include <cstdint>
#include <cmath>
...
int32_t main()
{
    ...
    for (int32_t i = 0; i < totalLen; i++) xHost[i] = (float)(7.0);
    ...
    if (errors == 0) printf("DATACOPY SIMULATION PASSED\n");
    else             printf("DATACOPY SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
