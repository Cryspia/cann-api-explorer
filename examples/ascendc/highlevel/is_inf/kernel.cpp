/*
 * AscendC high-level floating-point check operator IsInf (adv_api, simple count mode, no Tiling needed).
 * IsInf: dst = isinf(src). Output is bool (0/1).
 */
#include "kernel_operator.h"
#include "lib/math/is_inf.h"
