 ...
 * Input src=1.0 (float); output is bool. IsInf(1.0) -> 0 (false).
 */
#include <cstdlib>
#include <cstdio>
#include <cstdio>
...
int32_t main()
{
    ...
    const uint8_t expect = 0;  // IsInf(1.0) -> false
    int errors = 0;
    ...
    if (errors == 0) printf("IS_INF SIMULATION PASSED\n");
    else             printf("IS_INF SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
