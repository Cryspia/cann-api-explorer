/*
 * AscendC high-level math operator FasterGelu (fast gelu approximation) (adv_api, simple count mode, no Tiling needed).
...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::FasterGelu(zLocal, xLocal, TILE_LENGTH);
