 ...
 * dtype=int16_t (exact bit-for-bit match). x=12 (0b1100), y=10 (0b1010), verify x & y == 8 (0b1000).
 */
#include <cstdio>
#include <cstdint>
#include "acl/acl.h"
...
int32_t main()
{
    ...
    if (errors == 0) printf("BITWISE_AND SIMULATION PASSED\n");
    else             printf("BITWISE_AND SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
