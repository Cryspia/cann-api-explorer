/* Host: ClampMin, src all 1.0, scalar=3.0 -> expect dst ~ 3.0. */
#include <cstdio>
#include <cstdint>
#include <cmath>
#include "acl/acl.h"
...
int32_t main()
{
    ...
    if (errors == 0) printf("CLAMPMIN SIMULATION PASSED\n");
    else             printf("CLAMPMIN SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
