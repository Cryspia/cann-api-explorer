 ...
 * The input is filled with the constant 0.0; after the run the host-side verify expects ~ 0.0. dtype=float.
 */
#include <cstdio>
#include <cstdint>
#include <cmath>
...
int32_t main()
{
    ...
    if (errors == 0) printf("ASIN SIMULATION PASSED\n");
    else             printf("ASIN SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
