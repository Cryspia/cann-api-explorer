 ...
 * The input is filled with the constant 2.4; after the run the host-side verify expects ~ 2.0. dtype=float.
 */
#include <cstdio>
#include <cstdint>
#include <cmath>
...
int32_t main()
{
    ...
    for (int32_t i = 0; i < totalLen; i++) xHost[i] = (float)(2.4);
    bool golden = false;
    ...
    if (errors == 0) printf("ROUND SIMULATION PASSED\n");
    else             printf("ROUND SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
