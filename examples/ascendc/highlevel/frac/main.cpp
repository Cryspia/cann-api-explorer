 ...
 * The input is filled with the constant 2.75; after the run the host-side verify expects ~ 0.75. dtype=float.
 */
#include <cstdio>
#include <cstdint>
#include <cmath>
...
int32_t main()
{
    ...
    for (int32_t i = 0; i < totalLen; i++) xHost[i] = (float)(2.75);
    bool golden = false;
    ...
    if (errors == 0) printf("FRAC SIMULATION PASSED\n");
    else             printf("FRAC SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
