/*
 * Auto-generated: AscendC binary high-level operator (adv_api, with include) Power (element-wise, two input tensors).
...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Power(zLocal, xLocal, yLocal, TILE_LENGTH);
