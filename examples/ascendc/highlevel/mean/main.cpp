...
int32_t main()
{
    ...
    const int32_t OUT_ELEM = 64;  // aligned copy-out buffer; the mean lands in z[0]
    ...
    if (errors == 0) printf("MEAN SIMULATION PASSED\n");
    else             printf("MEAN SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
