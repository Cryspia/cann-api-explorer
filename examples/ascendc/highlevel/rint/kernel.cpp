/*
 * Auto-generated: AscendC high-level activation operator Rint (adv_api, simple count mode, no Tiling needed).
 * Rendered by harness/gen.py from manifest.yaml; do not edit by hand.
 */
#include "kernel_operator.h"
#include "lib/math/rint.h"
...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Rint(zLocal, xLocal, TILE_LENGTH);
