/*
 * AscendC high-level floating-point check operator IsFinite (adv_api, simple count mode, no Tiling needed).
 * IsFinite: dst = isfinite(src). Output is bool (0/1).
 */
#include "kernel_operator.h"
#include "lib/math/is_finite.h"
...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::IsFinite(d, s, TILE_LENGTH);
        outQueue.EnQue<DT>(d);
