 ...
 * The input is filled with the constant 1.0; after the run the host-side verify expects ~ -0.5772157. dtype=float.
 */
#include <cstdlib>
#include <cstdio>
#include <cstdio>
...
int32_t main()
{
    ...
    const float expect = (float)(-0.5772157);
    int errors = 0;
    ...
    if (errors == 0) printf("DIGAMMA SIMULATION PASSED\n");
    else             printf("DIGAMMA SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
