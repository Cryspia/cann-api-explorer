 ...
 * FasterGeluV2(0) = 0 (the formula multiplies by x).
 */
#include <cstdio>
#include <cstdint>
#include <cmath>
...
int32_t main()
{
    ...
    if (errors == 0) printf("FASTERGELUV2 SIMULATION PASSED\n");
    else             printf("FASTERGELUV2 SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
