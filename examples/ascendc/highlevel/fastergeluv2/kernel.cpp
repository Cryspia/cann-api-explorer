/*
 * AscendC high-level math operator FasterGeluV2 (fast gelu approximation, v2) (adv_api, simple count mode, no Tiling needed).
 * dst = OP(src) element-wise over a LocalTensor.
 */
...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::FasterGeluV2(zLocal, xLocal, TILE_LENGTH);
