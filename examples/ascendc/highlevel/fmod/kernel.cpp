/*
 * Auto-generated: AscendC binary high-level operator (adv_api, with include) Fmod (element-wise, two input tensors).
...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Fmod(zLocal, xLocal, yLocal, TILE_LENGTH);
