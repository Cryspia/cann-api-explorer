 ...
 * The input is filled with the constant 3.0; after the run the host-side verify expects ~ 1.0. dtype=float.
 */
#include <cstdio>
#include <cstdint>
#include <cmath>
...
int32_t main()
{
    ...
    if (errors == 0) printf("SIGN SIMULATION PASSED\n");
    else             printf("SIGN SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
