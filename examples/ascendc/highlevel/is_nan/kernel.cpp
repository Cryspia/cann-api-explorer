/*
 * AscendC high-level floating-point check operator IsNan (adv_api, simple count mode, no Tiling needed).
 * IsNan: dst = isnan(src). Output is bool (0/1).
 */
#include "kernel_operator.h"
#include "lib/math/is_nan.h"
