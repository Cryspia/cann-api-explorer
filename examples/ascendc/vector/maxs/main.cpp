 ...
 * The input is filled with the constant 1.0; after the run the host-side verify expects ~ 2.0. dtype=float.
 */
#include <cstdlib>
#include <cstdio>
#include <cstdio>
...
int32_t main()
{
    ...
    if (errors == 0) printf("MAXS SIMULATION PASSED\n");
    else             printf("MAXS SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
