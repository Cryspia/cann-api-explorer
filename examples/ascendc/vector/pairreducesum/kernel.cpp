/*
 * AscendC granularity-reduction operator PairReduceSum.
 * Sum adjacent pairs; output count is halved.
...
constexpr int32_t SRC_ELEM = 64;      // number of input elements
constexpr int32_t DST_ELEM = 32;   // 32B-aligned output element count copied to GM
constexpr int32_t REPEAT   = 1;   // repeat times
...
private:
    ...
    __aicore__ inline void Compute()
    {
        ...
        AscendC::PairReduceSum<DT>(zLocal, xLocal, REPEAT, MASK, 1, 1, 8);
