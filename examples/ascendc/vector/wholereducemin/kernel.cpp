/*
 * AscendC granularity-reduction operator WholeReduceMin.
 * Min of all 64 floats in each repeat (value-only order).
...
private:
    ...
    __aicore__ inline void Compute()
    {
        ...
        AscendC::WholeReduceMin<DT>(zLocal, xLocal, MASK, REPEAT, 1, 1, 8, AscendC::ReduceOrder::ORDER_ONLY_VALUE);
