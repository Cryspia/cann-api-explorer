/*
 * Auto-generated: AscendC vector-scalar operator Muls (element-wise, single input tensor + compile-time scalar 2.0).
...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Muls(zLocal, xLocal, (DT)2.0, TILE_LENGTH);
