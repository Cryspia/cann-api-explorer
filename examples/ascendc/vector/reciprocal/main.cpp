 ...
 * The input is filled with the constant 4.0; after the run the host-side verify expects ~ 0.25. dtype=float.
 */
#include <cstdio>
#include <cstdint>
#include <cmath>
...
int32_t main()
{
    ...
    if (errors == 0) printf("RECIPROCAL SIMULATION PASSED\n");
    else             printf("RECIPROCAL SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
