/*
 * Auto-generated host launcher (single input, integer bitwise ops): x=0, verify == -1.
...
int32_t main()
{
    ...
    for (int32_t i = 0; i < totalLen; i++) xHost[i] = (DT)(0);
    ...
    if (errors == 0) printf("NOT SIMULATION PASSED\n");
    else             printf("NOT SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
