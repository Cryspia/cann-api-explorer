/*
 * Auto-generated: AscendC cast operator Cast (element-wise, source float -> target int32_t).
 * Rendered by harness/gen.py from manifest.yaml; do not edit by hand; regenerate after changing the template or manifest.
 */
...
public:
    ...
    {
        xGm.SetGlobalBuffer((__gm__ ST *)x + BLOCK_LENGTH * AscendC::GetBlockIdx(), BLOCK_LENGTH);
        zGm.SetGlobalBuffer((__gm__ DT *)z + BLOCK_LENGTH * AscendC::GetBlockIdx(), BLOCK_LENGTH);
        pipe.InitBuffer(inQueueX, BUFFER_NUM, TILE_LENGTH * sizeof(ST));
...
private:
    ...
    __aicore__ inline void Compute(int32_t progress)
    {
        ...
        AscendC::Cast(zLocal, xLocal, AscendC::RoundMode::CAST_RINT, TILE_LENGTH);
