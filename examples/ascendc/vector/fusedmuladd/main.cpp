/* Host: FusedMulAdd, preset dst=1, src0=2, src1=3 -> expect dst = src0*dst+src1 = 2*1+3 = 5. */
#include <cstdio>
#include <cstdint>
#include <cmath>
#include "acl/acl.h"
...
int32_t main()
{
    ...
    if (errors == 0) printf("FUSEDMULADD SIMULATION PASSED\n");
    else             printf("FUSEDMULADD SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
