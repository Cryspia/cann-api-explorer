/*
 * Hand-written vector unit: VectorPadding (vector boundary padding, count mode).
 * VectorPadding(dst, src, padMode, padSide, count). The behavior of padMode/padSide was determined by simulation measurement.
 * src[i]=i, padMode=0, padSide=false -> dump dst for diagnosis.
 */
...
private:
    ...
    __aicore__ inline void Compute()
    {
        ...
        AscendC::VectorPadding(zL, xL, (uint8_t)0, false, N);
        outZ.EnQue<DT>(zL);
        inX.FreeTensor(xL);
    }
