...
## Functionality
AscendC vector compute interface `Prelu`, computes element-wise over a LocalTensor.
...
- src0=`-3.0`, src1=`0.5` -> expect `dst ~ -1.5`, host-side element-wise verify (tol 1e-3).
