/*
 * AscendC granularity-reduction operator WholeReduceSum.
 * Sum all 64 floats in each 256B repeat into 1 value.
...
private:
    ...
    __aicore__ inline void Compute()
    {
        ...
        AscendC::WholeReduceSum<DT>(zLocal, xLocal, MASK, REPEAT, 1, 1, 8);
