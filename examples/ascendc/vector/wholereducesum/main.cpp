/* Host launcher for WholeReduceSum: Sum all 64 floats in each 256B repeat into 1 value. */
#include <cstdio>
#include <cstdint>
#include <cmath>
#include "acl/acl.h"
...
int32_t main()
{
    ...
    if (errors == 0) printf("WHOLEREDUCESUM SIMULATION PASSED\n");
    else             printf("WHOLEREDUCESUM SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
