 ...
 * The input is filled with the constant -3.0; after the run the host-side verify expects ~ 3.0. dtype=float.
 */
#include <cstdio>
#include <cstdint>
#include <cmath>
...
int32_t main()
{
    ...
    for (int32_t i = 0; i < totalLen; i++) xHost[i] = (float)(-3.0);
    ...
    if (errors == 0) printf("ABS SIMULATION PASSED\n");
    else             printf("ABS SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
