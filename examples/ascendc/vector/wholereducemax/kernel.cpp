/*
 * AscendC granularity-reduction operator WholeReduceMax.
 * Max of all 64 floats in each repeat (value-only order).
...
private:
    ...
    __aicore__ inline void Compute()
    {
        ...
        AscendC::WholeReduceMax<DT>(zLocal, xLocal, MASK, REPEAT, 1, 1, 8, AscendC::ReduceOrder::ORDER_ONLY_VALUE);
