 ...
 * The input is filled with the constant 1.0; after the run the host-side verify expects ~ 1.0. dtype=float.
 */
#include <cstdlib>
#include <cstdio>
#include <cstdio>
...
int32_t main()
{
    ...
    if (errors == 0) printf("MINS SIMULATION PASSED\n");
    else             printf("MINS SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
