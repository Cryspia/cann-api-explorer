 ...
 * The input is filled with the constant 0.0; after the run the host-side verify expects ~ 1.0. dtype=float.
 */
#include <cstdio>
#include <cstdint>
#include <cmath>
...
int32_t main()
{
    ...
    for (int32_t i = 0; i < totalLen; i++) xHost[i] = (float)(0.0);
    ...
    if (errors == 0) printf("EXP SIMULATION PASSED\n");
    else             printf("EXP SIMULATION FAILED (%d errors)\n", errors);
    fflush(stdout);
