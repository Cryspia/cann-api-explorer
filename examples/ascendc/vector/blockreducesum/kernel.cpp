/*
 * AscendC granularity-reduction operator BlockReduceSum.
 * Sum the 8 floats in each 32B block; one 256B repeat (64 floats) yields 8 block sums.
...
constexpr int32_t DST_ELEM = 64;   // 32B-aligned output element count copied to GM
...
private:
    ...
    __aicore__ inline void Compute()
    {
        ...
        AscendC::BlockReduceSum<DT>(zLocal, xLocal, REPEAT, MASK, 1, 1, 8);
